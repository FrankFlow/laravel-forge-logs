...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/laravel-forge-logs.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/laravel-forge-logs)
...
```bash
php artisan vendor:publish --tag="laravel-forge-logs-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="laravel-forge-logs-config"
```
...
```bash
php artisan vendor:publish --tag="laravel-forge-logs-views"
```

## Usage

```php
$laravelForgeLogs = new FrankFlow\LaravelForgeLogs();
echo $laravelForgeLogs->echoPhrase('Hello, FrankFlow!');
```
